            ...
            <Table columns={['Username', 'Nama Akun', 'Catatan Pemohon', 'Diajukan', 'Status', 'Aksi']}>
                {data.map((p) => (
                    <tr key={p.id_permintaan}>
                        <td className="px-4 py-3 font-mono text-[#2563eb]">{p.username}</td>
                ...
                >
                    ...
                    >
                        ...
                        <textarea
                            ...
                            className="w-full rounded-md bg-[var(--color-bg)] border border-[var(--color-border)] px-3 py-2 text-sm text-[var(--color-text)] focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent resize-none mb-4"
                        />
