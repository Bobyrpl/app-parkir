    ...
    return (
        <div className="min-h-screen bg-white text-[#10131A] relative">
            ...
            <section className="relative w-full h-[500px] sm:h-[560px] md:h-[620px] overflow-hidden">
                ...
                {/* Gradasi gelap dari kiri (biar teks kontras) yang memudar
                    ...
                    <Reveal delay={0}>
                        <SectionCard className="h-full">
                            ...
                            <div className="flex items-end gap-2 mb-3">
                                <p className="font-display text-3xl text-[#5DCAA5]">
                                    <AnimatedCounter
                                        value={Math.max(
                                            0,
                                            statistik.kapasitas -
                    ...
                    <div className="space-y-5">
                        ...
                        <SectionCard>
                            ...
                            >
                                ...
                                {commentError && (
                                    <p
                                        className="flex items-center gap-1.5 text-xs text-[#D4537E]"
                                        role="alert"
                                    >
                                        <svg
                                            width="14"
